# No.17 1割貯蓄・3割投資 2P Manga Prompt
...
Panel 1 (Top 40%): Quiet library or study room with bookshelves. Remi (Silver hair, Red eyes, Red blazer) stands calmly next to a large holographic display showing "1割貯蓄・3割投資". Unlike usual, the screen shows a simple balanced symbol representing the concept, not complex charts. Yuto (Black hair, Gakuran) looks puzzled. Remi says "Dialogue Intro" (In a speech bubble). Title box: BLACK SLENDER box at bottom-left offset with white text "1割貯蓄・3割投資".
Panel 2 (Middle 30%): CONCEPTUAL ILLUSTRATION. Visual metaphor for '1割貯蓄・3割投資'. A clear comparison or balanced symbolic image representing the core concept of 1割貯蓄・3割投資. Remi points to the correct/positive side. She says "Dialogue Teach" (In a speech bubble).
...
Panel 1 (Top 40%): VISUAL MANIFESTATION. Close up on Remi holding a small, glowing sphere of light or symbol that represents '1割貯蓄・3割投資'. It shines brighter than the Background elements. She looks gentle and wise. "Dialogue Desc" (In a speech bubble).
Panel 2 (Middle 30%): CONTRAST SCENE (Metaphor). Remi stands in a split world. On her left, a chaotic storm or complex abstract shapes representing 'Confusion/Risk'. On her right, a peaceful, golden garden or orderly structure representing '1割貯蓄・3割投資'. She calmly points towards the peace/order.
