...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『1割貯蓄3割投資』について教えるわよ。"
   - Title box: "1割貯蓄3割投資"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "1割貯蓄3割投資". Draw a conceptual illustration representing '給料の一定割合を天引きして投資へ。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '1割貯蓄3割投資'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '1割貯蓄3割投資'. (Use symbolic imagery to represent the concept)
   - Remi says: "給料の一定割合を天引きして投資へ。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…1割貯蓄3割投資の本質はここにあったんですね。"
...
- **TITLE**: 1割貯蓄3割投資
- **DIALOGUE_THEME**: 「優斗君、今日は『1割貯蓄3割投資』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、給料の一定割合を天引きして投資へ。」
...
- **DIALOGUE_SUMMARY**: 「給料の一定割合を天引きして投資へ。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…1割貯蓄3割投資の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No17_1割貯蓄3割投資_p1.png
- p2: No17_1割貯蓄3割投資_p2.png
