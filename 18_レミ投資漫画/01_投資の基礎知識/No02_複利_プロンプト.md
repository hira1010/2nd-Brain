...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『複利』について教えるわよ。"
   - Title box: "複利"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "複利". Draw a conceptual illustration representing '利益が利益を生む魔法。雪だるま式に増える。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '複利'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '複利'. (Use symbolic imagery to represent the concept)
   - Remi says: "利益が利益を生む魔法。雪だるま式に増える。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…複利の本質はここにあったんですね。"
...
- **TITLE**: 複利
- **DIALOGUE_THEME**: 「優斗君、今日は『複利』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、利益が利益を生む魔法。雪だるま式に増える。」
...
- **DIALOGUE_SUMMARY**: 「利益が利益を生む魔法。雪だるま式に増える。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…複利の本質はここにあったんですね。」
