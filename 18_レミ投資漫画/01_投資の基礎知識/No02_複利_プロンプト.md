...
[Top]: [Intro Visual] Yuto and Remi. Dramatic lighting. **ILLUSTRATION REACHES x=0**. **TITLE RULE**: A HORIZONTAL black title box at bottom-right corner, white Japanese: "複利".

[Center]: [Discovery] Remi (センター分けの前髪). **SPEECH BUBBLE**: "'複利'。残酷な現実ね。" in JAPANESE. Content covers x=0 perfectly.
...
[Center]: [Core Truth] Yuto looking at radiant solution for beating "複利". Art floods x=0 with light. **PURE WHITE GUTTERS**.
