...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 一番は死んだ人
...
Speech bubble: 姉さん 一番は死んだ人 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 運用成績が最も良いのは放置された口座。
...
Scene: Dramatic visualization of 一番は死んだ人 concept
Narration: 運用成績が最も良いのは放置された口座。
...
- 1ページ目: No07_一番は死んだ人_p1.png
- 2ページ目: No07_一番は死んだ人_p2.png
