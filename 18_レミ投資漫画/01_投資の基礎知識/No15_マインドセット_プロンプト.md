...
[Panel 1 (Top, 40% height)]: [Cosmology] Giant golden glowing brain in deep space nebula. Pure 2D anime. **TITLE CARD**: A small horizontal black title box with Japanese text "マインドセット" (Ensure accurate spelling). NO ENGLISH.. **MANDATORY**: VERTICAL ORIENTATION.
