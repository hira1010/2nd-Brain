...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『ドルコスト平均法』について教えるわよ。"
   - Title box: "ドルコスト平均法"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "ドルコスト平均法". Draw a conceptual illustration representing '定期定額購入。高い時は少なく安い時は多く買う。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'ドルコスト平均法'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'ドルコスト平均法'. (Use symbolic imagery to represent the concept)
   - Remi says: "定期定額購入。高い時は少なく安い時は多く買う。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…ドルコスト平均法の本質はここにあったんですね。"
...
- **TITLE**: ドルコスト平均法
- **DIALOGUE_THEME**: 「優斗君、今日は『ドルコスト平均法』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、定期定額購入。高い時は少なく安い時は多く買う。」
...
- **DIALOGUE_SUMMARY**: 「定期定額購入。高い時は少なく安い時は多く買う。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…ドルコスト平均法の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No4_ドルコスト平均法_p1.png
- p2: No4_ドルコスト平均法_p2.png
