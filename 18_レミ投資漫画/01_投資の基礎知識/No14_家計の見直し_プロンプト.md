...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『家計の見直し』について教えるわよ。"
   - Title box: "家計の見直し"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "家計の見直し". Draw a conceptual illustration representing '保険や携帯など。無駄な固定費を削減。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '家計の見直し'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '家計の見直し'. (Use symbolic imagery to represent the concept)
   - Remi says: "保険や携帯など。無駄な固定費を削減。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…家計の見直しの本質はここにあったんですね。"
...
- **TITLE**: 家計の見直し
- **DIALOGUE_THEME**: 「優斗君、今日は『家計の見直し』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、保険や携帯など。無駄な固定費を削減。」
...
- **DIALOGUE_SUMMARY**: 「保険や携帯など。無駄な固定費を削減。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…家計の見直しの本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No14_家計の見直し_p1.png
- p2: No14_家計の見直し_p2.png
