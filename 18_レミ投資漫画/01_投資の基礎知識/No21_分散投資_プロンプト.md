...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『分散投資』について教えるわよ。"
   - Title box: "分散投資"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "分散投資". Draw a conceptual illustration representing '卵を一つのカゴに盛るな。リスクを分ける。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '分散投資'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '分散投資'. (Use symbolic imagery to represent the concept)
   - Remi says: "卵を一つのカゴに盛るな。リスクを分ける。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…分散投資の本質はここにあったんですね。"
...
- **TITLE**: 分散投資
- **DIALOGUE_THEME**: 「優斗君、今日は『分散投資』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、卵を一つのカゴに盛るな。リスクを分ける。」
...
- **DIALOGUE_SUMMARY**: 「卵を一つのカゴに盛るな。リスクを分ける。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…分散投資の本質はここにあったんですね。」
