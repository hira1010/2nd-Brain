...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 分散投資
...
Speech bubble: 姉さん 分散投資 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 卵を一つのカゴに盛るな。リスクを分ける。
...
Scene: Dramatic visualization of 分散投資 concept
Narration: 卵を一つのカゴに盛るな。リスクを分ける。
