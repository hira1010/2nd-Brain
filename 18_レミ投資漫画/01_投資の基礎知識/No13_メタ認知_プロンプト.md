...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『メタ認知』について教えるわよ。"
   - Title box: "メタ認知"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "メタ認知". Draw a conceptual illustration representing '自分を客観視する。パニック時に気づく力。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'メタ認知'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'メタ認知'. (Use symbolic imagery to represent the concept)
   - Remi says: "自分を客観視する。パニック時に気づく力。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…メタ認知の本質はここにあったんですね。"
...
- **TITLE**: メタ認知
- **DIALOGUE_THEME**: 「優斗君、今日は『メタ認知』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、自分を客観視する。パニック時に気づく力。」
...
- **DIALOGUE_SUMMARY**: 「自分を客観視する。パニック時に気づく力。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…メタ認知の本質はここにあったんですね。」
