...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ メタ認知
...
Speech bubble: 姉さん メタ認知 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 自分を客観視する。パニック時に気づく力。
...
Scene: Dramatic visualization of メタ認知 concept
Narration: 自分を客観視する。パニック時に気づく力。
