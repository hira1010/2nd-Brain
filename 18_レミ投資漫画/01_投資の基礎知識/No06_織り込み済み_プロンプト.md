...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 織り込み済み
...
Speech bubble: 姉さん 織り込み済み について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: ニュースや予測は既に株価に反映されている。
...
Scene: Dramatic visualization of 織り込み済み concept
Narration: ニュースや予測は既に株価に反映されている。
...
- 1ページ目: No06_織り込み済み_p1.png
- 2ページ目: No06_織り込み済み_p2.png
