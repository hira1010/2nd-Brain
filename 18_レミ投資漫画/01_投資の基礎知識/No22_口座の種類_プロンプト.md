...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 口座の種類
...
Speech bubble: 姉さん 口座の種類 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 特定口座が楽。一般口座は確定申告が必要。
...
Scene: Dramatic visualization of 口座の種類 concept
Narration: 特定口座が楽。一般口座は確定申告が必要。
