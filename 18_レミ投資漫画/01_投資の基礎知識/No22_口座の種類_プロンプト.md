...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『口座の種類』について教えるわよ。"
   - Title box: "口座の種類"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "口座の種類". Draw a conceptual illustration representing '特定口座が楽。一般口座は確定申告が必要。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '口座の種類'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '口座の種類'. (Use symbolic imagery to represent the concept)
   - Remi says: "特定口座が楽。一般口座は確定申告が必要。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…口座の種類の本質はここにあったんですね。"
...
- **TITLE**: 口座の種類
- **DIALOGUE_THEME**: 「優斗君、今日は『口座の種類』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、特定口座が楽。一般口座は確定申告が必要。」
...
- **DIALOGUE_SUMMARY**: 「特定口座が楽。一般口座は確定申告が必要。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…口座の種類の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No22_口座の種類_p1.png
- p2: No22_口座の種類_p2.png
