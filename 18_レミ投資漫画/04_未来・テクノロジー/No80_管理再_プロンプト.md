...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 管理再
...
Speech bubble: 姉さん 管理再 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: スプレッドシート等で資産を可視化し続ける。
...
Scene: Dramatic visualization of 管理再 concept
Narration: スプレッドシート等で資産を可視化し続ける。
