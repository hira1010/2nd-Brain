...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ ストップ高安
...
Speech bubble: 姉さん ストップ高安 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 日本株の値幅制限。行き過ぎを止める。
...
Scene: Dramatic visualization of ストップ高安 concept
Narration: 日本株の値幅制限。行き過ぎを止める。
