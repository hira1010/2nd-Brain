...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ ピケティ再
...
Speech bubble: 姉さん ピケティ再 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 富の集中は加速する。投資側に回る。
...
Scene: Dramatic visualization of ピケティ再 concept
Narration: 富の集中は加速する。投資側に回る。
