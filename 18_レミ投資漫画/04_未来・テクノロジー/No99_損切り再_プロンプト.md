...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 損切り再
...
Speech bubble: 姉さん 損切り再 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: サンクコストバイアスを捨てる。
...
Scene: Dramatic visualization of 損切り再 concept
Narration: サンクコストバイアスを捨てる。
