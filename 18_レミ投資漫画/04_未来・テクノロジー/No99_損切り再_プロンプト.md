...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『損切り再』について教えるわよ。"
   - Title box: "損切り再"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "損切り再". Draw a conceptual illustration representing 'サンクコストバイアスを捨てる。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '損切り再'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '損切り再'. (Use symbolic imagery to represent the concept)
   - Remi says: "サンクコストバイアスを捨てる。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…損切り再の本質はここにあったんですね。"
...
- **TITLE**: 損切り再
- **DIALOGUE_THEME**: 「優斗君、今日は『損切り再』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、サンクコストバイアスを捨てる。」
...
- **DIALOGUE_SUMMARY**: 「サンクコストバイアスを捨てる。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…損切り再の本質はここにあったんですね。」
