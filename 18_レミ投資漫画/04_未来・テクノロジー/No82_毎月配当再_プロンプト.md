...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 毎月配当再
...
Speech bubble: 姉さん 毎月配当再 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: インカムゲインの積み上げがFIREへの道。
...
Scene: Dramatic visualization of 毎月配当再 concept
Narration: インカムゲインの積み上げがFIREへの道。
