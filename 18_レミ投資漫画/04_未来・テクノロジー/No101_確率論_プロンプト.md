...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 確率論
...
Speech bubble: 姉さん 確率論 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 試行回数を増やす。分散投資。
...
Scene: Dramatic visualization of 確率論 concept
Narration: 試行回数を増やす。分散投資。
