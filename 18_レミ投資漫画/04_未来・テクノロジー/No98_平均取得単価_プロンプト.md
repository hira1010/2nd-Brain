...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『平均取得単価』について教えるわよ。"
   - Title box: "平均取得単価"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "平均取得単価". Draw a conceptual illustration representing 'ナンピン買いで単価を下げる技術。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '平均取得単価'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '平均取得単価'. (Use symbolic imagery to represent the concept)
   - Remi says: "ナンピン買いで単価を下げる技術。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…平均取得単価の本質はここにあったんですね。"
...
- **TITLE**: 平均取得単価
- **DIALOGUE_THEME**: 「優斗君、今日は『平均取得単価』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、ナンピン買いで単価を下げる技術。」
...
- **DIALOGUE_SUMMARY**: 「ナンピン買いで単価を下げる技術。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…平均取得単価の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No98_平均取得単価_p1.png
- p2: No98_平均取得単価_p2.png
