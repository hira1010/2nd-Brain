...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『致命傷を避ける』について教えるわよ。"
   - Title box: "致命傷を避ける"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "致命傷を避ける". Draw a conceptual illustration representing '再起不能な損失だけは避ける。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '致命傷を避ける'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '致命傷を避ける'. (Use symbolic imagery to represent the concept)
   - Remi says: "再起不能な損失だけは避ける。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…致命傷を避けるの本質はここにあったんですね。"
...
- **TITLE**: 致命傷を避ける
- **DIALOGUE_THEME**: 「優斗君、今日は『致命傷を避ける』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、再起不能な損失だけは避ける。」
...
- **DIALOGUE_SUMMARY**: 「再起不能な損失だけは避ける。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…致命傷を避けるの本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No94_致命傷を避ける_p1.png
- p2: No94_致命傷を避ける_p2.png
