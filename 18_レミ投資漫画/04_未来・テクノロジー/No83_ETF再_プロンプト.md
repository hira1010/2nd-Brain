...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ ETF再
...
Speech bubble: 姉さん ETF再 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 個別株より低リスク。初心者の最適解。
...
Scene: Dramatic visualization of ETF再 concept
Narration: 個別株より低リスク。初心者の最適解。
