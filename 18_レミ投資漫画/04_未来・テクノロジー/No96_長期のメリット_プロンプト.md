...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 長期のメリット
...
Speech bubble: 姉さん 長期のメリット について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 複利効果やストレス減や税金繰り延べ効果。
...
Scene: Dramatic visualization of 長期のメリット concept
Narration: 複利効果やストレス減や税金繰り延べ効果。
