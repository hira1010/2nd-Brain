...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ カルダシェフ尺度
...
Speech bubble: 姉さん カルダシェフ尺度 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 文明の進化レベル。人類はまだタイプ0。
...
Scene: Dramatic visualization of カルダシェフ尺度 concept
Narration: 文明の進化レベル。人類はまだタイプ0。
