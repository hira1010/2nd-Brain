...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『カルダシェフ尺度』について教えるわよ。"
   - Title box: "カルダシェフ尺度"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "カルダシェフ尺度". Draw a conceptual illustration representing '文明の進化レベル。人類はまだタイプ0。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'カルダシェフ尺度'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'カルダシェフ尺度'. (Use symbolic imagery to represent the concept)
   - Remi says: "文明の進化レベル。人類はまだタイプ0。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…カルダシェフ尺度の本質はここにあったんですね。"
...
- **TITLE**: カルダシェフ尺度
- **DIALOGUE_THEME**: 「優斗君、今日は『カルダシェフ尺度』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、文明の進化レベル。人類はまだタイプ0。」
...
- **DIALOGUE_SUMMARY**: 「文明の進化レベル。人類はまだタイプ0。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…カルダシェフ尺度の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No87_カルダシェフ尺度_p1.png
- p2: No87_カルダシェフ尺度_p2.png
