...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 戻る暴落
...
Speech bubble: 姉さん 戻る暴落 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 世界経済は右肩上がり。信じて待つ。
...
Scene: Dramatic visualization of 戻る暴落 concept
Narration: 世界経済は右肩上がり。信じて待つ。
