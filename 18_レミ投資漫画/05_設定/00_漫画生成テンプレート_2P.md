...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '{TITLE}'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '{TITLE}'. {VISUAL_INSTRUCTION_2}
   - Remi says: "{DIALOGUE_SUMMARY}"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "{DIALOGUE_ACTION_2}"
...
- **DIALOGUE_SUMMARY**: 「{DESCRIPTION} これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…{TITLE}の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No{NUMBER}_{TITLE}_p1.png
- p2: No{NUMBER}_{TITLE}_p2.png
