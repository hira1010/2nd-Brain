...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 固定費削減
...
Speech bubble: 姉さん 固定費削減 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 携帯代やサブスク。質素倹約が大事。
...
Scene: Dramatic visualization of 固定費削減 concept
Narration: 携帯代やサブスク。質素倹約が大事。
