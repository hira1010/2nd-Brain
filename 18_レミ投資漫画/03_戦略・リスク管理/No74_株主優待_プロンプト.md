...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『株主優待』について教えるわよ。"
   - Title box: "株主優待"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "株主優待". Draw a conceptual illustration representing '日本独自の文化。商品やサービス券がもらえる。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '株主優待'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '株主優待'. (Use symbolic imagery to represent the concept)
   - Remi says: "日本独自の文化。商品やサービス券がもらえる。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…株主優待の本質はここにあったんですね。"
...
- **TITLE**: 株主優待
- **DIALOGUE_THEME**: 「優斗君、今日は『株主優待』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、日本独自の文化。商品やサービス券がもらえる。」
...
- **DIALOGUE_SUMMARY**: 「日本独自の文化。商品やサービス券がもらえる。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…株主優待の本質はここにあったんですね。」
