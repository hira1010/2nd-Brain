...
[Top]: [Intro Visual] Yuto and Remi. Dramatic lighting. **ILLUSTRATION REACHES x=0**. **TITLE RULE**: A HORIZONTAL black title box at bottom-right corner, white Japanese: "権利確定日".

[Center]: [Discovery] Remi (センター分けの前髪). **SPEECH BUBBLE**: "'権利確定日'。残酷な現実ね。" in JAPANESE. Content covers x=0 perfectly.
...
[Center]: [Core Truth] Yuto looking at radiant solution for beating "権利確定日". Art floods x=0 with light. **PURE WHITE GUTTERS**.
