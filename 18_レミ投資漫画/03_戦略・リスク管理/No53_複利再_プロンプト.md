...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 複利再
...
Speech bubble: 姉さん 複利再 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 時間をかけるほど強大になる。
...
Scene: Dramatic visualization of 複利再 concept
Narration: 時間をかけるほど強大になる。
