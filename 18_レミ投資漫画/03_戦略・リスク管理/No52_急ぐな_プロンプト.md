...
Panel 1: Remi (in the SAME RED blazer) pointing at whiteboard, Yuto (in the SAME Black Gakuran) taking notes. Remi says "優斗君、今日は『急ぐな』について教えるわよ。" in a Japanese speech bubble. Title box: Black box with white Japanese text "急ぐな".
Panel 2: Remi (in the SAME RED blazer) explaining concepts. She says "『急いで金持ちになろうとするな』。ウォーレン・バフェットの言葉よ。" in a Japanese speech bubble.
...
- Yuto: Yuto: (Short Black hair:1.3). OUTFIT: (Traditional Black GAKURAN school uniform:1.4) with gold buttons. Identical clothes in every panel. NO GLOVES.
### PAGE LAYOUT (Portrait 1200x1697)
Panel 1: EPIC METAPHOR SCENE. Remi (in the SAME RED blazer) navigating a symbolic world of '急ぐな'. Digital charts in background. Remi has absolute authority.
Panel 2: Remi (in the SAME RED blazer) making a sharp gesture. She says "焦りは目を曇らせるわ。最短ルートに見える道は、たいてい崖へ続く落とし穴よ。一歩一歩、着実に積み上げた城だけが嵐に耐えられるの。" in a Japanese speech bubble.
Panel 3: Yuto (in the SAME Black Gakuran) visualizing profit with golden icons.
Panel 4: Yuto (in the SAME Black Gakuran) determined, Remi (in the SAME RED blazer) proud. Yuto says "焦らず地道に積み上げます！" in a bubble. Remi thinks "期待しているわよ。" in a small thoughts bubble.
