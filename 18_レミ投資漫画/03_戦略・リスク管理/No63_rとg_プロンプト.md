...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『rとg』について教えるわよ。"
   - Title box: "rとg"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "rとg". Draw a conceptual illustration representing '資本収益率が経済成長率を上回る。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'rとg'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'rとg'. (Use symbolic imagery to represent the concept)
   - Remi says: "資本収益率が経済成長率を上回る。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…rとgの本質はここにあったんですね。"
...
- **TITLE**: rとg
- **DIALOGUE_THEME**: 「優斗君、今日は『rとg』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、資本収益率が経済成長率を上回る。」
...
- **DIALOGUE_SUMMARY**: 「資本収益率が経済成長率を上回る。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…rとgの本質はここにあったんですね。」
