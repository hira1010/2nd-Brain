...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『投資仲間』について教えるわよ。"
   - Title box: "投資仲間"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "投資仲間". Draw a conceptual illustration representing '孤独にならない。情報共有し励まし合う。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '投資仲間'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '投資仲間'. (Use symbolic imagery to represent the concept)
   - Remi says: "孤独にならない。情報共有し励まし合う。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…投資仲間の本質はここにあったんですね。"
...
- **TITLE**: 投資仲間
- **DIALOGUE_THEME**: 「優斗君、今日は『投資仲間』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、孤独にならない。情報共有し励まし合う。」
...
- **DIALOGUE_SUMMARY**: 「孤独にならない。情報共有し励まし合う。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…投資仲間の本質はここにあったんですね。」
