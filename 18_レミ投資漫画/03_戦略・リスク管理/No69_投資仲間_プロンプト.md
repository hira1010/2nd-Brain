...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 投資仲間
...
Speech bubble: 姉さん 投資仲間 について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 孤独にならない。情報共有し励まし合う。
...
Scene: Dramatic visualization of 投資仲間 concept
Narration: 孤独にならない。情報共有し励まし合う。
