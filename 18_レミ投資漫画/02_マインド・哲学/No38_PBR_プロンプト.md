...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ PBR
...
Speech bubble: 姉さん PBR について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 株価純資産倍率。割安かどうかの指標。
...
Scene: Dramatic visualization of PBR concept
Narration: 株価純資産倍率。割安かどうかの指標。
