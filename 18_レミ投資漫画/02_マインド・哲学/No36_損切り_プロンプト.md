...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 損切り
...
Speech bubble: 姉さん 損切り について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 失敗を認めて傷を浅く済ませる技術。
...
Scene: Dramatic visualization of 損切り concept
Narration: 失敗を認めて傷を浅く済ませる技術。
