...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『損切り』について教えるわよ。"
   - Title box: "損切り"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "損切り". Draw a conceptual illustration representing '失敗を認めて傷を浅く済ませる技術。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '損切り'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '損切り'. (Use symbolic imagery to represent the concept)
   - Remi says: "失敗を認めて傷を浅く済ませる技術。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…損切りの本質はここにあったんですね。"
...
- **TITLE**: 損切り
- **DIALOGUE_THEME**: 「優斗君、今日は『損切り』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、失敗を認めて傷を浅く済ませる技術。」
...
- **DIALOGUE_SUMMARY**: 「失敗を認めて傷を浅く済ませる技術。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…損切りの本質はここにあったんですね。」
