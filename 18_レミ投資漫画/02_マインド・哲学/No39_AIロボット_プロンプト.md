...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『AIロボット』について教えるわよ。"
   - Title box: "AIロボット"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "AIロボット". Draw a conceptual illustration representing '次の産業革命。労働からの解放か。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'AIロボット'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'AIロボット'. (Use symbolic imagery to represent the concept)
   - Remi says: "次の産業革命。労働からの解放か。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…AIロボットの本質はここにあったんですね。"
...
- **TITLE**: AIロボット
- **DIALOGUE_THEME**: 「優斗君、今日は『AIロボット』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、次の産業革命。労働からの解放か。」
...
- **DIALOGUE_SUMMARY**: 「次の産業革命。労働からの解放か。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…AIロボットの本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No39_AIロボット_p1.png
- p2: No39_AIロボット_p2.png
