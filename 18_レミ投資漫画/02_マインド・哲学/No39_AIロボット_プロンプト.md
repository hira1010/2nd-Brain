...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ AIロボット
...
Speech bubble: 姉さん AIロボット について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 次の産業革命。労働からの解放か。
...
Scene: Dramatic visualization of AIロボット concept
Narration: 次の産業革命。労働からの解放か。
