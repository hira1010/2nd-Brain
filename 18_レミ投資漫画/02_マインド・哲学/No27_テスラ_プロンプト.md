...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『テスラ』について教えるわよ。"
   - Title box: "テスラ"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "テスラ". Draw a conceptual illustration representing '革新的な企業の代表例。夢を買う。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'テスラ'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'テスラ'. (Use symbolic imagery to represent the concept)
   - Remi says: "革新的な企業の代表例。夢を買う。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…テスラの本質はここにあったんですね。"
...
- **TITLE**: テスラ
- **DIALOGUE_THEME**: 「優斗君、今日は『テスラ』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、革新的な企業の代表例。夢を買う。」
...
- **DIALOGUE_SUMMARY**: 「革新的な企業の代表例。夢を買う。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…テスラの本質はここにあったんですね。」
