...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 年金の手取り
...
Speech bubble: 姉さん 年金の手取り について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 額面と手取りは違う。税金が引かれる。
...
Scene: Dramatic visualization of 年金の手取り concept
Narration: 額面と手取りは違う。税金が引かれる。
