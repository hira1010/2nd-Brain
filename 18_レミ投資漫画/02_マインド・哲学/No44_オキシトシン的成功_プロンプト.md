...
[Top]: [Intro Visual] Yuto and Remi. Dramatic lighting. **ILLUSTRATION REACHES x=0**. **TITLE RULE**: A HORIZONTAL black title box at bottom-right corner, white Japanese: "オキシトシン的成功".

[Center]: [Discovery] Remi (センター分けの前髪). **SPEECH BUBBLE**: "'オキシトシン的成功'。残酷な現実ね。" in JAPANESE. Content covers x=0 perfectly.
...
[Center]: [Core Truth] Yuto looking at radiant solution for beating "オキシトシン的成功". Art floods x=0 with light. **PURE WHITE GUTTERS**.
