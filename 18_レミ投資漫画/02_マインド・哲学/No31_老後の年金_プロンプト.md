...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『老後の年金』について教えるわよ。"
   - Title box: "老後の年金"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "老後の年金". Draw a conceptual illustration representing '平均月額では生きられない現実。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '老後の年金'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '老後の年金'. (Use symbolic imagery to represent the concept)
   - Remi says: "平均月額では生きられない現実。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…老後の年金の本質はここにあったんですね。"
...
- **TITLE**: 老後の年金
- **DIALOGUE_THEME**: 「優斗君、今日は『老後の年金』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、平均月額では生きられない現実。」
...
- **DIALOGUE_SUMMARY**: 「平均月額では生きられない現実。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…老後の年金の本質はここにあったんですね。」

---

## 保存ファイル名

- p1: No31_老後の年金_p1.png
- p2: No31_老後の年金_p2.png
