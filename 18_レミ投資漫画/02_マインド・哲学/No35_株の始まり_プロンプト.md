...
[Top]: [Intro Visual] Yuto and Remi. Dramatic lighting. **ILLUSTRATION REACHES x=0**. **TITLE RULE**: A HORIZONTAL black title box at bottom-right corner, white Japanese: "株の始まり".

[Center]: [Discovery] Remi (センター分けの前髪). **SPEECH BUBBLE**: "'株の始まり'。残酷な現実ね。" in JAPANESE. Content covers x=0 perfectly.
...
[Center]: [Core Truth] Yuto looking at radiant solution for beating "株の始まり". Art floods x=0 with light. **PURE WHITE GUTTERS**.
