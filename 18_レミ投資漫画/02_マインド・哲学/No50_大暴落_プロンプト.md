...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『大暴落』について教えるわよ。"
   - Title box: "大暴落"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "大暴落". Draw a conceptual illustration representing '戻らない暴落はない。歴史が証明している。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of '大暴落'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of '大暴落'. (Use symbolic imagery to represent the concept)
   - Remi says: "戻らない暴落はない。歴史が証明している。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…大暴落の本質はここにあったんですね。"
...
- **TITLE**: 大暴落
- **DIALOGUE_THEME**: 「優斗君、今日は『大暴落』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、戻らない暴落はない。歴史が証明している。」
...
- **DIALOGUE_SUMMARY**: 「戻らない暴落はない。歴史が証明している。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…大暴落の本質はここにあったんですね。」
