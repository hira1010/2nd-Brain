...
TEXT BOX in Panel 1 BOTTOM-RIGHT: Black box with white text: テーマ 塩漬け
...
Speech bubble: 姉さん 塩漬け について教えてください

Panel 2 - Explanation:
Scene: Close-up of silver-haired woman explaining
Speech bubble: 含み損で売れなくなった状態。
...
Scene: Dramatic visualization of 塩漬け concept
Narration: 含み損で売れなくなった状態。
