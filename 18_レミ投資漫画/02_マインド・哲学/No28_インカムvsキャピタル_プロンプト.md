...
Panel 1 (Top 40%): Bright high-tech office. Remi (Silver hair, Red eyes, Red blazer) stands calmly next to a large holographic display showing "インカムvsキャピタル". Unlike usual, the screen shows a simple balanced symbol representing the concept, not complex charts. Yuto (Black hair, Gakuran) looks puzzled. Remi says "優斗君、今日は『インカムvsキャピタル』について教えるわよ。" (In a speech bubble). Title box: BLACK SLENDER box at bottom-left offset with white text "インカムvsキャピタル".
Panel 2 (Middle 30%): CONCEPTUAL ILLUSTRATION. Visual metaphor for 'インカムvsキャピタル'. A clear comparison or balanced symbolic image representing the core concept of インカムvsキャピタル. Remi points to the correct/positive side. She says "いい心がけね。でも、ただ知るだけじゃ意味がないわ。" (In a speech bubble).
...
Panel 1 (Top 40%): VISUAL MANIFESTATION. Close up on Remi holding a small, glowing sphere of light or symbol that represents 'インカムvsキャピタル'. It shines brighter than the Background elements. She looks gentle and wise. "配当狙いか値上がり狙いか。 これが投資の本質よ。しっかり頭に叩き込みなさい。" (In a speech bubble).
...
Panel 4 (Bottom-Left 15%): Yuto looking enlightened and relieved (Realization). Yuto says "そうか…インカムvsキャピタルの本質はここにあったんですね。" (In a speech bubble). Remi smiles gently, watching him grow. (No text for Remi).
...
| :--- | :--- |
| TIP_NUMBER | 28 |
| TIP_TITLE | インカムvsキャピタル |
| DIALOGUE_INTRO | レミさん、インカムvsキャピタルについて教えてください！もっと詳しく知りたいです。 |
...
| 変数 | 値 |
| :--- | :--- |
| DIALOGUE_DESC | 配当狙いか値上がり狙いか。 これが投資の本質よ。しっかり頭に叩き込みなさい。 |
| DIALOGUE_ACTION | そうか…インカムvsキャピタルの本質はここにあったんですね。 |

---

## 保存ファイル名

- 1ページ目: No28_インカムvsキャピタル_p1.png
- 2ページ目: No28_インカムvsキャピタル_p2.png
...
generate_image(
  ImageName: "remi_investment_no28_p1",
...
画像生成を行ってください。以下のプロンプトに基づいて、縦長のマンガ画像を生成してください。
generate_image(
  ImageName: "remi_investment_no28_p2",
