...
Speech bubbles:
レミさん、ESBIについて教えてください！もっと詳しく知りたいです。
...
Scene: Remi standing in front of a large holographic monitor or blackboard showing the concept of "ESBI". She is explaining it directly to Yuto.
Characters:
...
Visual Background: Symbolic representation of ESBI (Charts, Coins, Crown, etc.) on the screen.
Speech bubbles: 金持ち父さんの4つのクワドラント。 これが投資の本質よ。しっかり頭に叩き込みなさい。
...
Speech bubbles: ポイント1：ESBIの重要性よ！
