...
Panel 1 (Top 25%): THEME INTRO. Bright office. Remi (in RED blazer) speaks to Yuto.
   - Remi says: "優斗君、今日は『ESBI』について教えるわよ。"
   - Title box: "ESBI"
...
Panel 3 (Middle-Bottom 35%): VISUAL EXPLANATION (KEY PANEL).
   - Visual: Use Icons/Charts/Diagrams to visually explain "ESBI". Draw a conceptual illustration representing '金持ち父さんの4つのクワドラント。'.
...
### LAYOUT & CONTENT
Panel 1 (Top 40%): EPIC METAPHOR. Remi navigating a symbolic world of 'ESBI'.
...
Panel 2 (Middle 30%): STRONG SUMMARY. Visual manifestation of the concept.
   - Visual: The background vividly illustrates the concept of 'ESBI'. (Use symbolic imagery to represent the concept)
   - Remi says: "金持ち父さんの4つのクワドラント。 これが投資の本質よ。しっかり頭に叩き込みなさい。"
...
Panel 4 (Bottom-Left 15%): DETERMINATION.
   - Yuto (Left) says: "そうか…ESBIの本質はここにあったんですね。"
...
- **TITLE**: ESBI
- **DIALOGUE_THEME**: 「優斗君、今日は『ESBI』について教えるわよ。」
- **DIALOGUE_TEACH_1**: 「いい心がけね。でも、ただ知るだけじゃ意味がないわ。 つまり、金持ち父さんの4つのクワドラント。」
...
- **DIALOGUE_SUMMARY**: 「金持ち父さんの4つのクワドラント。 これが投資の本質よ。しっかり頭に叩き込みなさい。」
- **DIALOGUE_ACTION_2**: 「そうか…ESBIの本質はここにあったんですね。」
