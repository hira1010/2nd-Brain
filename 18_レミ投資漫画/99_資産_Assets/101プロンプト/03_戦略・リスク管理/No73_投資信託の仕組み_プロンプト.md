...
[Panel 1]: Bright meeting room with a large whiteboard. Remi stands calmly next to a large holographic display showing '投資信託の仕組み'. Unlike usual, the screen shows a simple balanced symbol. Yuto looks puzzled.
