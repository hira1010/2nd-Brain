# No.95 虎穴に入らずんば 2P Manga Prompt
...
Panel 2 (Middle 30%): CONCEPTUAL ILLUSTRATION. Visual metaphor for '虎穴に入らずんば'. A clear comparison or balanced symbolic image representing the core concept of 虎穴に入らずんば. Remi points to the correct/positive side. She says "Dialogue Teach" (In a speech bubble).
...
Panel 1 (Top 40%): VISUAL MANIFESTATION. Close up on Remi holding a small, glowing sphere of light or symbol that represents '虎穴に入らずんば'. It shines brighter than the Background elements. She looks gentle and wise. "Dialogue Desc" (In a speech bubble).
